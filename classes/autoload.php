 ...
 * @category PHP
 * @package WordPress
 * @subpackage RalfAlbert\Tooling\Autoload
...
namespace RalfAlbert\Tooling\Autoload;
...
class Autoload
{
	...
	public static function load( $class ) {
		...
		if ( true == strpos( $class, '\\' ) ) {
			$class = preg_replace( '#.+\\\#is', '', $class );
		}
...
// 		die(var_dump(self::$whitelist_classes));
